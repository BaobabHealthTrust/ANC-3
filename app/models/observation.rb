class Observation < ActiveRecord::Base
  ...
  belongs_to :concept_name, ->{where(voided: 0)}, class_name: "ConceptName", foreign_key: "concept_name", optional: true
  belongs_to :answer_concept, -> { where retired: 0 },  class_name: "Concept", foreign_key: "value_coded", optional: true
  belongs_to :answer_concept_name, -> { where voided: 0 }, class_name: "ConceptName", foreign_key: "value_coded_name_id", optional: true
